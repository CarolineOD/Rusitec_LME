...
#mean(VFA_averages$mM_VFA[VFA_averages$Treatment=="Liquid UHP" & VFA_averages$Name==" ACE"])
#mean(VFA_averages$mM_VFA[VFA_averages$Treatment=="Powder UHP" & VFA_averages$Name==" ACE"])
#mean(VFA_averages$mM_VFA[VFA_averages$Treatment=="Control" & VFA_averages$Name==" PROP"])
#mean(VFA_averages$mM_VFA[VFA_averages$Treatment=="Liquid UHP" & VFA_averages$Name==" PROP"])
#mean(VFA_averages$mM_VFA[VFA_averages$Treatment=="Powder UHP" & VFA_averages$Name==" PROP"])
